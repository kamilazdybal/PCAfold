...
.. code-block:: text
  ...
  The number of train samples that will be select from each cluster is 46.
...
.. code-block:: text
  ...
  Selected 125 train samples (10%) and 1125 test samples (90%).
...
.. code:: python
  ...
  (idx_train, idx_test) = tts.train_test_split_random(n_observations, 10, idx_test=[], verbose=True)
...
.. image:: ../images/tutorial-train-test-select-random.png
  :width: 700
  :align: center
