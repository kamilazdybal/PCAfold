...
class Analysis(unittest.TestCase):
    ...
    def test_reconstruction__RegressionAssessment_print_metrics__allowed_calls(self):
...
# ------------------------------------------------------------------------------
    ...
    def test_reconstruction__RegressionAssessment_print_metrics__not_allowed_calls(self):
