...
# ------------------------------------------------------------------------------
    ...
    def test_analysis__KReg_allowed_class_init(self):

        pass

# ------------------------------------------------------------------------------

    def test_analysis__KReg_not_allowed_class_init(self):

        pass

# ------------------------------------------------------------------------------

    def test_analysis__KReg_constant_bandwidth(self):
        self.assertTrue(np.all(self._krmod.compute_constant_bandwidth(self._query, 1.5) == np.array([[1.5, 1.5]])))

# ------------------------------------------------------------------------------

    def test_analysis__KReg_isotropic_bandwidth(self):
        self.assertTrue(np.all(self._krmod.compute_bandwidth_isotropic(self._query, np.array([1.5])) == np.array([[1.5, 1.5]])))

# ------------------------------------------------------------------------------

    def test_analysis__KReg_anisotropic_bandwidth(self):
        self.assertTrue(
            np.all(self._krmod.compute_bandwidth_anisotropic(self._query, np.array([1.5, 2.0])) == np.array([[1.5, 2.0]])))

# ------------------------------------------------------------------------------

    def test_analysis__KReg_nearest_neighbors_isotropic_bandwidth(self):
