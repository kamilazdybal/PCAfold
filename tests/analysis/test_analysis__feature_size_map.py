...
# ------------------------------------------------------------------------------
    ...
    def test_analysis__feature_size_map__sample_variance_not_available(self):
        ...
        with self.assertRaises(ValueError):
            feature_size_map = analysis.feature_size_map(variance_data, variable_name='X_1', cutoff=1, starting_bandwidth_idx='peak', use_variance=True, verbose=False)

        with self.assertRaises(ValueError):
            feature_size_map = analysis.feature_size_map(variance_data, variable_name='X_1', cutoff=1, starting_bandwidth_idx='peak', use_variance=False, verbose=False)
